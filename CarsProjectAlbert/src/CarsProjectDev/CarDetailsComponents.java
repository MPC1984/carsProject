...
/**
 * This class contains the group of text fields representing the cars
 * information visually inside a panel. @
 *
 * PUBLIC FEATURES: // Constructors public CarDetailsComponents()
 *
 * // Methods public void clearTextFields() public void
 ...
 * componentShown(ComponentEvent ev) public void displayDetails(Car c) public
 * JPanel getDetailsPanel() public String getInfoText() public String
 * getKmText() public String getManufacturerText() public String getModelText()
 * public String getPriceText() public String getYearText() public void
 * setFocusManufacturerTextField()
 *
 * COLLABORATORS:
 *
...
public class CarDetailsComponents extends JPanel implements ComponentListener {
	...
	private static final int DIVFACTOR = 27;

	/**
	 * set up a new CarDetailComponents object and return a reference to the object
	 * which is a kind of panel
	 */
	public CarDetailsComponents() {
		...
		gridBagConstraints.anchor = gridBagConstraints.WEST;
		gridBagConstraints.weightx = 1.0;
		compPanel.add(new JScrollPane(infoTextArea, JScrollPane.VERTICAL_SCROLLBAR_ALWAYS,
				JScrollPane.HORIZONTAL_SCROLLBAR_NEVER), gridBagConstraints);
