 ...
 *
 * PUBLIC FEATURES: // Constructors public Manufacturer(String nam, Car c)
 *
 * // Methods public void addCar(Car c) public int carCount() public Car[]
 * getAllCars() public Car[] getAllCars() public String getManufacturerName()
 * private Car[] resizeArray(Car[] c, int extendBy) public void
 * setManufacturersName(String nam)
 *
 * COLLABORATORS: Car
 *
