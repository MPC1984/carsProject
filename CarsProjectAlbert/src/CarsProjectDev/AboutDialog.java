 ...
 *
 * PUBLIC FEATURES: // Constructors public AboutDialog(JFrame parent, String
 * title, boolean modal)
 *
 * // Methods public void actionPerformed(ActionEvent ev) public void closing()
 * public void showAbout() public int addNewCar(Car c) public void closing()
 *
 * COLLABORATORS:
 *
...
public class AboutDialog extends JDialog implements ActionListener {
	 ...
	 * @param modal  modal means focus cannot be taken away from the dialog,
	 *               non-modal means it can.
	 */
	...
	/**
	 * Hides for from focus, so it can be made visible without needing a new
	 * instance
	 */
	public void closing() {
		setVisible(false);
	...
	/**
	 * default method to show about dialog. This ensures it is centred on the parent
	 * form. Please ensure you do not use the setVisible() method directly, use this
	 * one instead.
	 */
